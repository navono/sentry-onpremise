...
AUTH_LDAP_SERVER_URI = 'ldap://10.10.20.15:389'
AUTH_LDAP_BIND_DN = 'ldap'
AUTH_LDAP_BIND_PASSWORD = 'ldapldap'

OU=unicode('OU=用  户,OU=系统软件分中心,dc=rd,dc=supcon,dc=com', 'utf8')
...
AUTH_LDAP_GROUP_SEARCH = LDAPSearch(
    'ou=Groups,dc=rd,dc=supcon,dc=com',
    ldap.SCOPE_SUBTREE,
...
AUTH_LDAP_DEFAULT_EMAIL_DOMAIN = 'supcon.com'
